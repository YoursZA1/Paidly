        ...
        <div className={`rounded-xl flex items-center justify-center shrink-0 ${
          ...
          {iconImageSrc ? (
            <img
              ...
              width={48}
              height={48}
              className={`${fintech ? "w-5 h-5 sm:w-6 sm:h-6" : "w-6 h-6 sm:w-7 sm:h-7"} object-contain contrast-125 saturate-125 drop-shadow-[0_1px_1px_rgba(0,0,0,0.18)] dark:contrast-110 dark:saturate-110 dark:drop-shadow-[0_1px_1px_rgba(255,255,255,0.12)]`}
              loading="lazy"
              decoding="async"
