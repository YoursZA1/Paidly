...
export const ADMIN_NAV_GROUPS = [
  ...
  },
  {
    ...
    label: "Documents",
    items: [
      { label: "Invoices", path: "/admin-v2/invoices", icon: FileText, roles: ALL_STAFF },
      { label: "Quotes", path: "/admin-v2/quotes", icon: ScrollText, roles: ALL_STAFF },
      { label: "POS", path: "/admin-v2/pos", icon: Store, roles: ALL_STAFF },
      { label: "Payments", path: "/admin-v2/payments", icon: Banknote, roles: ALL_STAFF },
      { label: "Recurring Documents", path: "/admin-v2/recurring", icon: Repeat, roles: ALL_STAFF },
    ],
  },
  {
    id: "workforce",
    label: "Workforce",
    items: [
      { label: "Employees", path: "/admin-v2/employees", icon: UserRound, roles: ALL_STAFF },
      { label: "Payroll", path: "/admin-v2/payroll", icon: Wallet, roles: ALL_STAFF },
      { label: "Leave", path: "/admin-v2/leave", icon: CalendarOff, roles: ALL_STAFF },
      { label: "Attendance", path: "/admin-v2/attendance", icon: Clock, roles: ALL_STAFF },
      { label: "Payslips", path: "/admin-v2/payslips", icon: Receipt, roles: ALL_STAFF },
    ],
  },
  {
    id: "financial",
