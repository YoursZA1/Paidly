...
export default function ClassicTemplate({ invoice, client, user, bankingDetail, userCurrency, safeFormatDate, documentTitle }) {
    ...
    return (
        <div className="invoice bg-card">
            ...
            {/* Bill to | Dates — 2-column grid (print/PDF keeps two columns) */}
            <section className="client invoice-grid-bill-dates mb-6 sm:mb-8">
                <div>
                    <h3 className="text-xs sm:text-sm font-semibold text-muted-foreground uppercase mb-2">Bill to</h3>
            ...
            <div className="invoice-layout">
                <div className="invoice-layout-main">
                    ...
                    <thead className="bg-primary/10 border-b border-primary/20">
                        <tr>
                            <th className="pl-2 pr-2 sm:pl-3 sm:pr-3 py-2.5 sm:py-3 text-left text-xs font-semibold text-foreground uppercase tracking-wider">Description</th>
                            ...
                            <th className="pl-2 pr-4 sm:pl-3 sm:pr-4 py-2.5 sm:py-3 text-right text-xs font-semibold text-foreground uppercase whitespace-nowrap">Price</th>
            ...
            {/* Footer block: payment details, terms, then notes (last) */}
            {(bankingDetail ||
