                ...
                <Table className="min-w-[800px]">
                    <TableHeader>
                        <TableRow className="hover:bg-transparent border-border">
                            <TableHead className="text-muted-foreground text-xs font-medium">Invoice #</TableHead>
                            <TableHead className="text-muted-foreground text-xs font-medium">Client</TableHead>
                            <TableHead className="text-muted-foreground text-xs font-medium">Project Title</TableHead>
                            <TableHead className="text-muted-foreground text-xs font-medium">Amount</TableHead>
                            <TableHead className="text-muted-foreground text-xs font-medium">Paid</TableHead>
                            ...
                            invoices.map(invoice => {
                                ...
                                return (
                                    <TableRow key={invoice.id} className="border-border hover:bg-muted/50">
                                        ...
                                        <TableCell className="text-muted-foreground">{getClientName(invoice.client_id)}</TableCell>
                                        <TableCell className="text-muted-foreground">{invoice.project_title}</TableCell>
                                        <TableCell className="font-semibold text-foreground">{formatCurrency(invoice.total_amount, userCurrency)}</TableCell>
                                        <TableCell>
                                            {totalPaid > 0 ? (
                                        ...
                                        <TableCell className="text-muted-foreground">{invoice.created_date ? format(new Date(invoice.created_date), "MMM d, yyyy") : 'N/A'}</TableCell>
                                        <TableCell>
