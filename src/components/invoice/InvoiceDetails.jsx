    ...
    <div className="space-y-6">
      ...
      <div className="bg-card rounded-3xl p-8 border border-border shadow-sm">
        <div className="flex items-center gap-3 mb-6">
          ...
          <h2 className="text-xl font-semibold text-foreground">Invoice Info</h2>
        </div>
      ...
      <div className="bg-card rounded-3xl p-8 border border-border shadow-sm">
        <div className="flex justify-between items-center mb-6">
          ...
          <div className="flex gap-2">
            <Button
              type="button"
              className="text-primary font-bold text-xs px-4 py-2 bg-primary/8 rounded-xl hover:bg-primary/15"
              onClick={() => {
                setItemHistory((h) => [...h, invoiceData.items]);
                setInvoiceData((prev) => ({
                  ...prev,
        ...
        <div className="flex gap-3 mb-6 p-3 bg-muted/50 rounded-2xl border border-dashed border-border">
          ...
          />
          <Button type="button" size="icon" className="bg-primary hover:bg-primary/90 text-primary-foreground h-9 w-9 rounded-lg shrink-0" onClick={addQuickItem}>
        ...
        {/* Items list */}
            {(invoiceData.items && invoiceData.items.length > 0) ? (
                    ...
                    <div key={idx} className="bg-muted/50 p-4 sm:p-6 rounded-2xl space-y-4">
                      ...
                      <div className="grid md:grid-cols-2 gap-4">
                        <div className="space-y-2 md:col-span-2">
                          <Label className="text-sm font-semibold text-foreground">Product/Service *</Label>
                          <Popover>
              ...
              <div className="text-center py-10 bg-muted/50 rounded-2xl">
                <p className="text-muted-foreground text-sm font-medium">No items yet. Start by adding a service.</p>
              </div>
            )}
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="flex items-center gap-3 p-4 bg-primary/5 rounded-2xl">
            ...
            <div className="flex-1 min-w-0">
              <Label className="text-[10px] font-semibold text-muted-foreground/70 uppercase tracking-widest">Due Date</Label>
              <Input
                type="date"
                value={invoiceData.delivery_date}
                onChange={(e) => setInvoiceData((prev) => ({ ...prev, delivery_date: e.target.value }))}
                className="bg-transparent border-none p-0 h-auto text-sm font-bold text-foreground focus-visible:ring-0"
              />
            </div>
          </div>
          <div className="flex items-center gap-3 p-4 bg-muted/50 rounded-2xl">
            ...
            <div className="flex-1 min-w-0">
              <Label className="text-[10px] font-semibold text-muted-foreground/70 uppercase tracking-widest">Tax Rate (%)</Label>
              <Input
                type="number"
                min="0"
                step="0.1"
                ...
                className="bg-transparent border-none p-0 h-auto text-sm font-bold text-foreground focus-visible:ring-0 w-full"
              />
            </div>
          </div>
        </div>
      ...
      <div className="bg-card rounded-3xl p-8 border border-border shadow-sm">
        ...
        <div className="grid md:grid-cols-1 gap-6">
          <div className="space-y-2">
            <Label className="text-[10px] font-semibold text-muted-foreground/70 uppercase tracking-widest ml-1">Project Description</Label>
            <Textarea
              value={invoiceData.project_description}
              onChange={(e) => setInvoiceData((prev) => ({ ...prev, project_description: e.target.value }))}
              placeholder="Describe the project in detail..."
              className="min-h-24 rounded-2xl border-none bg-muted/50 focus-visible:ring-2 focus-visible:ring-ring/20"
            />
          </div>
          <div className="space-y-2">
            <Label className="text-[10px] font-semibold text-muted-foreground/70 uppercase tracking-widest ml-1">Additional Notes</Label>
            <Textarea
          ...
          <div className="space-y-2">
            <Label className="text-[10px] font-semibold text-muted-foreground/70 uppercase tracking-widest ml-1">Terms & Conditions</Label>
            <Textarea
