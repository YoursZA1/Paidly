...
const AlertDialogFooter = ({
  ...
  <div
    className={cn("flex flex-col-reverse gap-buttons sm:flex-row sm:justify-end sm:gap-buttons", className)}
    {...props} />
)
